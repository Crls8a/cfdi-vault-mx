...
|---|---|---|---|---|---|---|---|
| `cfdi-32-income` | Declared `3.2`, type `I`, legacy-shaped basic invoice | Version-specific scaffold returns `partial`; accepted 3.2 legacy attributes remain future extractor work | `complete` | `completed` | Dedicated 3.2 extractor returns COMMON and no business complement is pending | COMMON | EVIDENCE, including the original XML |
| `cfdi-33-income` | Declared `3.3`, type `I`, no business complement | Version-specific scaffold returns `partial` until a dedicated 3.3 extractor is accepted | `complete` | `completed` | Dedicated 3.3 extractor returns COMMON and no business complement is pending | COMMON | EVIDENCE |
