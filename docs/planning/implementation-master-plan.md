...
| PARSER-005B | feature | Parser | `feature/cfdi-version-detector` | PARSER-005A | Implement version detector and unknown-version behavior. | Synthetic fixture tests cover 3.2/3.3/4.0/unknown. |
